...
results_folder = '~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2'
...
xenium_folder = '~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2'
...
cell_bound_path = paste0('~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2/cell_boundaries.csv.gz')
nuc_bound_path = paste0('~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2/nucleus_boundaries.csv.gz')
tx_path = paste0('~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2/transcripts.csv.gz')
feat_meta_path = paste0('~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2/cell_feature_matrix/features.tsv.gz') # (also used in aggregate)
...
Xenium_labels<-c("Neutrophil_Ngp high",#1
                 "C1q+ Macrophage",#2
                 "T cell",#3
                 "Endothelial cell",#4
                 "Stromal cell",#5
...
names(mycolorcode) = c('Neutrophil_Ngp high', 'Erythroid cell','T cell', 'Dendritic cell', 
                       'Stromal cell', 'C1q+ Macrophage','Megakaryocyte', 'Neutrophil_S100a8 high', 'NK cell', 'Endothelial cell')
dimPlot2D(gobject = xenium_gobj,     dim_reduction_name = 'umap',
...
write_xlsx(xenium_gobj@cell_metadata[["cell"]][["rna"]]@metaDT, "~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2/NCcellmeta.xlsx")


write_xlsx(cell_proximities[["enrichm_res"]], "~/Desktop/Xenium/Giotto/Mouse samples analysis/spleen2/NCcellproximity.xlsx")
