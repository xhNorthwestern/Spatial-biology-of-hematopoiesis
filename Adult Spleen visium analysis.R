results_folder = '~/Desktop/Visium/The second eight mouse samples/Adult_spleen/2'
...
data_path = '~/Desktop/Visium/The second eight mouse samples/Adult_spleen'
...
write.xlsx(Spatialcorrelation@enrichDT, file = "myworkbookSpleen.xlsx",
