results_folder = '~/Desktop/Visium/The second eight mouse samples/P8_bone_marrow/2'
...
data_path = '~/Desktop/Visium/The second eight mouse samples/P8_bone_marrow'
...
write.xlsx(Spatialcorrelation@enrichDT, file = "myworkbookBM.xlsx",
