results_folder = 'C:/Users/ser/Desktop/Visium/WT2_FetalLiver/WT2_FetalLiver/3'
...
data_path = 'C:/Users/ser/Desktop/Visium/WT2_FetalLiver/WT2_FetalLiver'
...
spatPlot2D(visium_E14.5FetalLiver, cell_color = 'leiden_clus', label_size = 10,
           coord_fix_ratio = 1, point_size = 4, show_legend = F, axis_text = 16,
           axis_title = 16)
...
spatCellPlot2D(gobject = visium_E14.5FetalLiver,
               spat_enr_names = 'PAGE',
               cell_annotation_values = cell_types_PAGE[1],
               cow_n_col = 1,coord_fix_ratio = 1, point_size = 7, show_legend = T)
...
write.xlsx(Spatialcorrelation@enrichDT, file = "myworkbook.xlsx",
