...
results_folder = '~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/3'
...
xenium_folder = '~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM'
...
cell_bound_path = paste0('~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/cell_boundaries.csv.gz')
nuc_bound_path = paste0('~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/nucleus_boundaries.csv.gz')
tx_path = paste0('~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/transcripts.csv.gz')
feat_meta_path = paste0('~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/cell_feature_matrix/features.tsv.gz') # (also used in aggregate)
...
Xenium_labels<-c("Neutrophil_Ltf high",#1
                 "B cell",#2
                 "Neutrophil_Mpo high",#3
                 "Stromal cell",#4
                 "Neutrophil_Srgn high",#5
                 "Erythroid cell",#6
                 "Neutrophil_Ltf high",#7
                 "C1q+ macrophage",#8
                 "Macrophage_Ctss high",#9
                 "B cell",#10
                 "Erythroid cell",#11
                 "B cell",#12
                 "Erythroid cell",#13
                 ...
                 "T cell",#18
                 "Eosinophil",#19
                 "Neutrophil_Ltf high",#20
                 "Megakaryocyte",#21
                 "Erythroid cell",#22
                 "Neutrophil_Ltf high",#23
                 "Macrophage_Ctss high")#24
names(Xenium_labels)<-1:24
...
mycolorcode = c('plum', 'red', 'magenta', 'pink',
                'purple', 'yellowgreen', 'yellow', 'gray', 'orange', 'lavender', 'cyan', 'lightblue')
names(mycolorcode) = c('Neutrophil_Ltf high', 'Erythroid cell', 'Neutrophil_Mpo high', 'HSPC',
                       'Stromal cell', 'C1q+ macrophage', 'Megakaryocyte', 'Neutrophil_Srgn high', 'T cell', 'B cell', 'Eosinophil', 'Macrophage_Ctss high')
dimPlot2D(gobject = xenium_gobj,     dim_reduction_name = 'umap',
...
subloc4 = subsetGiottoLocs(xenium_gobj,
                           x_min = 3940, x_max = 4130,
                           y_min = 1050, y_max = 1240,
                           poly_info = 'cell')
...
write_xlsx(xenium_gobj@cell_metadata[["cell"]][["rna"]]@metaDT, "~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/3/89weeksBMcellmeta.xlsx")


write_xlsx(cell_proximities[["enrichm_res"]], "~/Desktop/Xenium 5K assay/Mouse/Giotto Analysis/89 weeks BM/3/89weeksBMcellproximity.xlsx")
