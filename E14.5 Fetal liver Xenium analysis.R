...
results_folder = '~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL'
...
xenium_folder = '~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL'
...
cell_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL/cell_boundaries.csv.gz')
nuc_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL/nucleus_boundaries.csv.gz')
tx_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL/transcripts.csv.gz')
feat_meta_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL/cell_feature_matrix/features.tsv.gz') # (also used in aggregate)
...
Xenium_labels<-c("Erythroid cell",#1
                   "Erythroid cell",#2
                   "C1q+ Macrophage",#3
...
names(mycolorcode) = c('Neutrophil', 'Erythroid cell', 'Epithelial cell', 'Erythroid progenitor cell', 
...
xenium_gobj_subset1 = subsetGiottoLocs(xenium_gobj,
                                      x_max = 7000,
                                      x_min = 6000,
                                      y_max = 2000,
                                      y_min = 1000)

spatInSituPlotPoints(xenium_gobj_subset1,
                     show_image = FALSE,
                     feats = list('rna' = c(
                       "Car2", "C1qb", "Kit")),
                     feats_color_code = c(
...
spatInSituPlotPoints(subloc,
                     feats = list('rna' = c("Car2", "C1qa", "C1qb", 'C1qc', 'Kit')),
                     point_size = 0.6,
                     show_polygon = TRUE,
                     polygon_feat_type = 'cell',
                     polygon_color = 'white',
...
subloc4 = subsetGiottoLocs(xenium_gobj,
                           x_min = 900, x_max = 1000,
                           y_min = 1700, y_max = 1800,
                           poly_info = 'cell')
...
write_xlsx(xenium_gobj@cell_metadata[["cell"]][["rna"]]@metaDT, "~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL/E145FLcellmeta.xlsx")


write_xlsx(cell_proximities[["enrichm_res"]], "~/Desktop/Xenium/Giotto analysis/Mouse samples/E145FL/E145FLcellproximity.xlsx")
