...
results_folder = '~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen'
...
xenium_folder = '~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen'
...
cell_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen/cell_boundaries.csv.gz')

nuc_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen/nucleus_boundaries.csv.gz')
tx_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen/transcripts.csv.gz')
feat_meta_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen/cell_feature_matrix/features.tsv.gz') # (also used in aggregate)
...
Xenium_labels<-c("Erythroid cell",#1
                 ...
                 "C1q+ Macrophage",#4
                 "Endothelial cell",#5
                 "Neutrophil_S100a8 high",#6
                 "Erythroid cell",#7
                 "C1q+ Macrophage",#8
                 "Stromal cell",#9
                 "T cell",#10
                 "Neutrophil_Ngp high")#11
names(Xenium_labels)<-1:11
...
mycolorcode = c('magenta', 'red', 'lavender', 
                'purple', 'yellowgreen', 'plum', 'orange')
names(mycolorcode) = c('Neutrophil_Ngp high', 'Erythroid cell','T cell',  
                       'Stromal cell', 'C1q+ Macrophage', 'Neutrophil_S100a8 high', 'Endothelial cell')
dimPlot2D(gobject = xenium_gobj,     dim_reduction_name = 'umap',
...
subloc6 = subsetGiottoLocs(xenium_gobj,
                           x_min = 950, x_max = 1050,
                           y_min = 1370, y_max = 1470,
                           poly_info = 'cell')
...
write_xlsx(xenium_gobj@cell_metadata[["cell"]][["rna"]]@metaDT, "~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen/PHZcellmeta.xlsx")


write_xlsx(cell_proximities[["enrichm_res"]], "~/Desktop/Xenium/Giotto analysis/Mouse samples/PHZspleen/PHZcellproximity.xlsx")
