...
results_folder = '~/Desktop/Visium/Supplemental assays/Mouse/E145FLR1/2'
...
data_path = '~/Desktop/Visium/Supplemental assays/Mouse/E145FLR1'
...
spatCellPlot2D(gobject = visium_E14.5FetalLiver,
               spat_enr_names = 'PAGE',
               cell_annotation_values = cell_types_PAGE[6:9],
...
write_xlsx(Spatialcorrelation@enrichDT, "~/Desktop/Visium/Supplemental assays/Mouse/E145FLR1/2/myworkbook.xlsx")
