...
results_folder = '~/Desktop/Visium/Supplemental assays/Human/141C1-2A/2'
...
data_path = '~/Desktop/Visium/Supplemental assays/Human/141C1-2A'
...
visium_YoungControl <- doLeidenCluster(gobject = visium_YoungControl, resolution = 0.4, n_iterations = 1000)
...
visium_YoungControl = runPAGEEnrich(gobject = visium_YoungControl, sign_matrix = PAGE_matrix_1, min_overlap_genes = 5)
...
write_xlsx(Spatialcorrelation@enrichDT, "~/Desktop/Visium/Supplemental assays/Human/141C1-2A/2/141C1-2A correlation analysis.xlsx")
