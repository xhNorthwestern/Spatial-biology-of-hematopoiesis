results_folder = '~/Desktop/Visium/The second eight mouse samples/E14-5_fetal_liver'
...
data_path = '~/Desktop/Visium/The second eight mouse samples/E14-5_fetal_liver'
