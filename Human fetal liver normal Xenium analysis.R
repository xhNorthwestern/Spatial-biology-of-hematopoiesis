...
results_folder = '~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/2'
...
xenium_folder = '~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL'
...
cell_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/cell_boundaries.csv.gz')
nuc_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/nucleus_boundaries.csv.gz')
tx_path = paste0('~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/transcripts.csv.gz')
feat_meta_path = paste0('~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/cell_feature_matrix/features.tsv.gz') # (also used in aggregate)
...
Xenium_labels<-c("Hepatocyte",#1
                 "Erythroid cell_HBB high",#2
                 "Erythroid cell_HBM high",#3
                 "Endothelial cell",#4
                 "C1Q+ macrophage",#5
                 "Stromal cell",#6
                 "Erythroid progenitor cell",#7
                 "Neutrophil",#8
                 "Hepatocyte",#9
                 "Erythroid progenitor cell",#10
                 "C1Q+ macrophage",#11
                 "Erythroid progenitor cell")#12
names(Xenium_labels)<-1:12
...
mycolorcode = c('magenta', 'red', 'lavender','cyan', 
                'purple', 'yellowgreen', 'yellow', 'orange')
names(mycolorcode) = c('Erythroid progenitor cell', 'Erythroid cell_HBB high','Hepatocyte', 'Endothelial cell', 
                       'Stromal cell', 'C1Q+ macrophage', 'Neutrophil', 'Erythroid cell_HBM high')
dimPlot2D(gobject = xenium_gobj,     dim_reduction_name = 'umap',
...
subloc = subsetGiottoLocs(xenium_gobj,
                          x_min = 500, x_max = 1000,
                          y_min = 2000, y_max = 2500,
                          poly_info = 'cell')
...
spatPlot2D(gobject = subloc4, point_size = 6.0,
           ...
           axis_title = 12,
           cell_color = 'Xenium_labels', cell_color_code = mycolorcode,
           select_cell_groups = c('C1Q+ macrophage','Erythroid cell_HBB high', 'Erythroid cell_HBM high'), show_other_cells = F)
...
spatPlot2D(gobject = subloc4, point_size = 6.0,
           ...
           axis_title = 12,
           cell_color = 'Xenium_labels', cell_color_code = mycolorcode,
           select_cell_groups = c('C1Q+ macrophage', 'Erythroid cell_HBB high', 'Erythroid cell_HBM high', 'Erythroid progenitor cell'), show_other_cells = F)
...
spatPlot2D(gobject = subloc4, point_size = 6.0,
           ...
           axis_title = 12,
           cell_color = 'Xenium_labels', cell_color_code = mycolorcode,
           select_cell_groups = c('C1Q+ macrophage', 'Endothelial cell', 'Hepatocyte', 'Stromal cell'), show_other_cells = F)
...
spatPlot2D(gobject = subloc4, point_size = 6.0,
           ...
           axis_title = 12,
           cell_color = 'Xenium_labels', cell_color_code = mycolorcode,
           select_cell_groups = c('C1Q+ macrophage', 'Endothelial cell', 'Hepatocyte', 'Stromal cell', 'Neutrophil'), show_other_cells = F)


library(writexl)

write_xlsx(xenium_gobj@cell_metadata[["cell"]][["rna"]]@metaDT, "~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/2/NormalFLcellmeta.xlsx")


write_xlsx(cell_proximities[["enrichm_res"]], "~/Desktop/Xenium/Giotto analysis/Human samples/HumanFL/2/NormalFLcellproximity.xlsx")
