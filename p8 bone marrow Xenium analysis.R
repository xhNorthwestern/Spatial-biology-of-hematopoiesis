...
results_folder = '~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/2'
...
xenium_folder = '~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM'
...
cell_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/cell_boundaries.csv.gz')
nuc_bound_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/nucleus_boundaries.csv.gz')
tx_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/transcripts.csv.gz')
feat_meta_path = paste0('~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/cell_feature_matrix/features.tsv.gz') # (also used in aggregate)
...
Xenium_labels<-c("Neutrophil_Mmp8 high",#1
                 "Erythroid cell",#2
                 "Erythroid cell",#3
                 "Neutrophil_Mpo high",#4
                 "Stromal cell",#5
                 "C1q+ macrophage",#6
                 "Endothelial cell",#7
                 "Muscle cell",#8
...
names(mycolorcode) = c('Neutrophil_Mmp8 high', 'Erythroid cell', 'Epithelial cell', 'Neutrophil_Mpo high',
                       'Stromal cell', 'C1q+ macrophage', 'Megakaryocyte', 'Muscle cell', 'Endothelial cell')
dimPlot2D(gobject = xenium_gobj,     dim_reduction_name = 'umap',
...
cellProximityNetwork(gobject = xenium_gobj, CPscore = cell_proximities,
                     remove_self_edges = F, self_loop_strength = 0.2,
...
subloc5 = subsetGiottoLocs(xenium_gobj,
                           x_min = 1850, x_max = 1950,
                           y_min = 2750, y_max = 2880,
                           poly_info = 'cell')
...
write_xlsx(xenium_gobj@cell_metadata[["cell"]][["rna"]]@metaDT, "~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/Cellmeta.xlsx")


write_xlsx(cell_proximities[["enrichm_res"]], "~/Desktop/Xenium/Giotto analysis/Mouse samples/P8BM/Cellproximity.xlsx")
